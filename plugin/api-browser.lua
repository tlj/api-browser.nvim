...
vim.api.nvim_create_user_command("ApiBrowserSelectEnv", require("api-browser").select_env, {})
vim.api.nvim_create_user_command("ApiBrowserSelectRemoteEnv", require("api-browser").select_remote_env, {})
